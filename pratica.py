print("-- Reservatório de Água --") #Reservatorio esta escrito errado, faltou fechar o nparenteses
...
if(auton_reser >=2 and auton_reser = 7): # faltou o símbolo '=' estava elif invez de if
     print("Consumo Moderado")
if(auton_reser > 7): #estava elif invez de if
